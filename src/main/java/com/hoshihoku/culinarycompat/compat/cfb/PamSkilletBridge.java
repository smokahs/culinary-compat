...
public final class PamSkilletBridge {
	public static final ResourceLocation SKILLET_ITEM_ID = new ResourceLocation(PamCuttingBridge.PAM_MODID,
			"skilletitem");
